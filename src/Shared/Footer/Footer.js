    ...
    return (
        <footer className="footer p-10 bg-base-200 text-base-content container mx-auto">
            <div>
                ...
                <p className='font-bold text-2xl'>CTG FOOD</p>
               <small>Providing reliable tech since 2020</small> 
            </div>
            <div>
                ...
                <a className="link link-hover">Accebility</a>
            </div>
            <div>
            ...
            <div>
                ...
                <a className="link link-hover">ctgfood@gmail.com</a>
